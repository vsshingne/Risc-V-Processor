...
void check_registers(
    ...
    uint32_t x4)
{
    check(x1, dut.debug_x1, "x1");
    check(x2, dut.debug_x2, "x2");
    check(x3, dut.debug_x3, "x3");
    check(x4, dut.debug_x4, "x4");
}
...
int main(int argc,char **argv)
{
    ...
    // check(0, dut.debug_x1, "x1");
    // check(0, dut.debug_x2, "x2");
    // check(0, dut.debug_x3, "x3");
    // check(0, dut.debug_x4, "x4");
    check_registers(dut, 0, 0, 0, 0);   // Reset
